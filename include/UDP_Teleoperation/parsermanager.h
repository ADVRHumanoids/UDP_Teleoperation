...
public:
  ...
  AngularSegmentKinematicsDatagram* getAngularSegmentKinematicsDatagram() {return NULL;};
  ...
  LinearSegmentKinematicsDatagram* getLinearSegmentKinematicsDatagram() {return NULL;};
