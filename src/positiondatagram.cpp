...
/*! \class PositionDatagram
  ...
  4 bytes x of point position
  4 bytes y of point position
  4 bytes z of point position
...
void PositionDatagram::deserializeData(Streamer &inputStreamer)
{
	...
	{
		positionVirtualMarkerSet marker;
...
*/
std::vector<positionVirtualMarkerSet> PositionDatagram::getData()
{
  return m_data;
}
